...
GO
EXEC sp_rename 'dbo.sp_AddPaymentClient', 'sp_AddPaymentClient_OLD_08022026131128';
GO
...
END
GO
PRINT 'DEPLOYMENT COMPLETE: sp_AddPaymentClient fixed, original preserved as sp_AddPaymentClient_OLD_08022026131128.';
